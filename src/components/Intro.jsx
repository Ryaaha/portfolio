...
function Intro()
{
    return( 
        <div className="flex items-center justify-Center flex-col text-center pt-20 pb-6">
            <h1 className="text-3xl md:text-7xl mb-1 md:mb-3 font-bold">Vinit Malik</h1>
            ...
            I am currently a Sophomore doing my Bachelors in Computer Science at UPES - University of Petroleum and Energy Studies, Dehradun.</p>
        </div>
    )
}
